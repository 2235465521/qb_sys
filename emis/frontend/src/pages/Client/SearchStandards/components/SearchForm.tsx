      ...
      >
        ...
        {expanded && (
          <>
            ...
            <Row gutter={16} style={{ marginTop: 16 }} align="middle">
              <Col xs={24} md={12}>
                <Form.Item label="实施日期" name="implementDate" style={{ marginBottom: 0 }} labelCol={{ span: 5 }}>
                  <FlexibleDateSelector />
                </Form.Item>
              </Col>
              <Col xs={24} md={12}>
                <Form.Item label="发布时期" name="publishDate" style={{ marginBottom: 0 }} labelCol={{ span: 5 }}>
                  <FlexibleDateSelector />
                </Form.Item>
              </Col>
            </Row>
